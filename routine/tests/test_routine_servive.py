...
class TestRoutineService(TestCase):
    ...
    def test_rotuine_to_day_get_service(self):
        """
        routine 의 요일별로 get하는 service 를 검증
        """
        ...
        response = rotuine_to_day_get_service(request_data=request_data)   
    ...
    def test_when_wrongdata_rotuine_to_day_get_service(self):
        """
        routine 의 요일별로 get하는 service 를 검증
    ...
    def test_routine_short_get_service(self):
        """
        routine 의 단건 rouitne  get 하는 service 를 검증
        """
        ...
        response = routine_short_get_service(request_data=request_data)
    ...
    def test_when_wrongdata_routine_short_get_service(self):
        """
        routine 의 단건 rouitne  get 하는 service 를 검증
        case: 잘못된 type 의 데이터가 들어올 경우
        """
    ...
    def test_routine_update_service(self):
        """
        routine 의 update를 담당하는 service 를 검증
        """
        ...
        update = routine_update_service(update_data=self.update_data,account_id=self.user.id)
    ...
    def test_when_wrongdata_routine_update_service(self):
        """
        routine 의 update를 담당하는 service 를 검증
    ...
    def test_when_keyerror_routine_update_service(self):
        """
        routine 의 update를 담당하는 service 를 검증
        ...
        with self.assertRaises(KeyError):
            routine_update_service(update_data=self.update_data,account_id=self.user.id)

    def test_routine_delete_service(self):
        """
        routine_delete_service 의 delete를 담당하는 service 를 검증
        """
    ...
    def test_when_does_not_exist_test_routine_delete_service(self):
        """
        routine_delete_service 의 delete를 담당하는 service 를 검증
    ...
    def test_when_wrong_data_exist_test_routine_delete_service(self):
        """
        routine_delete_service 의 delete를 담당하는 service 를 검증
    ...
    def test_routine_result_put_service(self):
        """
        routine_result 의 결과를 수정하는 service를 검증
        """
    ...
    def test_when_does_not_exist_routine_result_put_service(self):
        """
        routine_result 의 결과를 수정하는 service를 검증
    ...
    def test_when_wrong_data_routine_result_put_service(self):
        """
        routine_result 의 결과를 수정하는 service를 검증
        case: 잘못된 데이터 형식이 들어올 때
        """
